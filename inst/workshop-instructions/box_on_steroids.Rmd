...
6. Create an HTML dependency pointing to the previously created script, that is `boxBinding.js`. This will be necessary to test the developed code. As a reminder, we may use `create_custom_dependency("box", script = "boxBinding.js")`.
